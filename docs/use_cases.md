...
| **ОСНОВНИЙ СЦЕНАРІЙ:** | 1. Гість натискає кнопку "Увійти" на головній сторінці. <br/> 2. Гість вводить електронну пошту і пароль у форму <br/> 3. Гість натискає кнопку "Увійти". <br/> 4. Система перевіряє облікові дані. <br/> 5. Система виводить, що вхід успішно виконано. |
...
| **ОСНОВНИЙ СЦЕНАРІЙ:** | 1. Користувач натискає кнопку "Вийти" на головній сторінці. <br/> 2. Користувач натискає кнопку "Підтвердити". <br/> 3. Система завершує сеанс користувача. <br/> 4. Сиситема виводить підтвердження про успішний вихід з облікового запису. |
